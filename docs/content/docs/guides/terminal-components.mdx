...
ink-web provides two main components for rendering Ink applications in the browser: `InkTerminalBox` and `InkXterm`. These components handle the ghostty-web integration and provide a terminal-like environment for your Ink components.
