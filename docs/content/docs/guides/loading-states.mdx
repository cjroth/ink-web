...
An animated progress bar that fills from 0 to 100%.

import LoadingProgressDemoWrapper from '@/components/demos/loading-progress-demo-wrapper'

<LoadingProgressDemoWrapper />
