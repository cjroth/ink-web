    ...
    <div className="flex flex-col justify-center items-center text-center flex-1 gap-8 p-8">
      ...
      <Accordions type="single" className="w-full max-w-3xl text-left">
        <Accordion title="How does it work?">
          Ink Web wraps Ink, polyfills the necessary Node.js APIs, and connects Ink to Xterm.js.
        </Accordion>
        ...
        <Accordion title="Is Ink Web production-ready?">
          No. This is a new and untested project that should be considered experimental.
        </Accordion>
        <Accordion title="What is Ink Web's relation to Ink?">
          Ink is a project by <a href="https://vadimdemedes.com/" className="underline hover:text-foreground">Vadim Demedes</a>. Ink Web is a separate project by <a href="https://cjroth.com" target="_blank" rel="noopener noreferrer" className="underline hover:text-foreground">Chris Roth</a>, a different author.
        </Accordion>
      </Accordions>
    </div>
  )
