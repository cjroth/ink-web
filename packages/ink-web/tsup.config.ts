...
export default defineConfig([
  // Core bundle - small, requires vite plugin (ink is external)
  {
    ...
    target: 'es2020',
    platform: 'browser',
    external: ['react', 'react-dom', 'ink', 'ghostty-web'],
  },
  ...
  // Compatible with Next.js and other React 19+ environments
  {
    ...
    external: ['react', 'react-dom', 'react/jsx-runtime', 'react/jsx-dev-runtime', 'scheduler', 'react-reconciler', 'ghostty-web'],
    noExternal: [
      'ink',
      'chalk',
      'cli-cursor',
    ...
    esbuildOptions(options) {
      ...
      options.external = ['react', 'react-dom', 'react/jsx-runtime', 'react/jsx-dev-runtime', 'scheduler', 'react-reconciler', 'ghostty-web']
...
import * as __ghostty_web__ from 'ghostty-web';
...
const require = globalThis.__bundled_require__;
  ...
  // Next.js specific exports
  {
    ...
    target: 'es2020',
    platform: 'browser',
    external: ['react', 'react-dom', 'next', 'next/dynamic', 'ghostty-web', 'ink-web', 'ink-web/css'],
  },
